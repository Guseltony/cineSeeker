...
const Hero = () => {
  ...
  const heroRightCol = useRef(null)
  const leftHeroCol = useRef(null)
  ...
  //     }
  //   )
  //     .set(heroRightCol.current, {opacity: 1})
  ...
  useLayoutEffect(() => {
    ...
    tl
    .from(leftHeroCol.current, {opacity:0, duration: 1})
    .from(bannerTitle.current, {
      opacity: 0,
      duration: 1,
      x: -200
    ...
    <section className='relative'>
      ...
      <div className='relative w-screen min-h-[90dvh] flex items-end justify-between'>
        ...
        <div className='hidden lg:block' >
          <div className='hidden z-[60] absolute bottom-0 right-0 flex-center flex-col md:gap-8 xl:gap-12 lg:mr-2 lg:mb-16 2xl:mr-8 opacity-0' ref={heroRightCol} >
            {
              heroMovies?.map((movie, index) => (
                <div key={index} className='  flex items-end' ref={(el) => (heroMoviesList.current[index] = el)}>
                  ...
                  <div className='lg:w-[250px] xl:w-[300px] 2xl:w-[400px] h-fit bg-black/70 backdrop-blur-2xl px-2 py-2 rounded-r-2xl shadow-xl mb-2'
                      style={{
                      boxShadow: `
                        2px 2px 5px #00b4d8,
                        0 0 0 #0077b6,
                  ...
                  >
                    ...
                    <div className='flex items-center xl:space-x-4 2xl:space-x-8 xl:my-1'>
                      <div className='text-lg flex-center'>
                        <MdOutlineStar size={20} color={'var(--color-primary)'} className='mr-2' />
                        <span className='font-anton text-lg text-secondary-hover'>{(movie.vote_average).toFixed(1)}</span> / <span className='text-xs self-end mb-0.5'>10</span>
                      </div>
                    ...
                    <FaPlayCircle size={25} className='text-secondary hover:text-primary-hover transition-all duration-200 ease-in mt-4 cursor-pointer'/>
                  </div>
                </div>
              ))
            }
